                        ...
                        @if ($aula->finalizada == 1)
                            <tr>
                                ...
                                <td class="btn-group mr-2" role="group" aria-label="acoes">
                                    <a href="{{route('check_up',[$turmas->find($aula->id_turma)->id])}}" style="white-space: nowrap;" class="btn btn-warning btn-sm style="white-space: nowrap; >Check-Up</a>
